...
class MarketChart extends React.Component {  
    ...
    async componentDidMount() {
        try {
            ...
            // Map the stakes data to the ordered days, ensuring correct order and handling missing data
            const seriesData = [{
                name: "Stake",
                data: daysOfWeekOrdered.map(day => (data[day] || 0))
            }];
            // Update the component state with the series data
    ...
    render() {
        return (
            <div id="activity1">
                {/* Render the ApexChart component with the provided options and series data */}
