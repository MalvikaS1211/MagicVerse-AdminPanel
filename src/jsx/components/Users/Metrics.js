...
export const MetricsData = () => {
  ...
  const packageList = [1000, 2000, 3000, 4000, 5000];
    ...
    <Fragment>
      <Row>
          ...
          {/* <Dropdown className="btn-group mb-1">
            ...
            <Dropdown.Menu>
              {packageList.map((data, i) => (
                <Dropdown.Item onClick={()=>{setSelectedPackage(data)}}>Package ({data})</Dropdown.Item>
              ))}
            </Dropdown.Menu>
          </Dropdown> */}
        ...
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Level Summary</Card.Title>
            </Card.Header>
            <Card.Body>
              <Table responsive>
