...
const formatTimestamp = (timestamp) => {
  ...
  const filteredRowCount = useMemo(() => filteredData.length, [filteredData]);
  // const pageSizeOverride = filteredRowCount > 0 ? filteredRowCount : pageSize;
  return (
    <Fragment>
      <Row>
      <div
        ...
        <Col lg={12}>
          ...
          <Card.Header style={{background:"black", border: '1px solid white'}}>
                  <Card.Title style={{color:"white",margin:"auto"}}>Transaction</Card.Title>
                </Card.Header>
              ...
              <thead>
                ...
                {filteredData.map((user, index) => (
                    <tr>
                      ...
                      {/* <td>{user.rank}</td>
                      <td>{user.teamBusiness/1e18}</td> */}
                      {/* <td>{user.txHash.slice(0, 5)}...{user.txHash.slice(-5)}</td> */}
              ...
              <div className="filter-pagination  mt-3 bg-black"  >
                ...
                {/* <div className="filter-count mt-3">
              <span>Filtered Data: {filteredRowCount}</span>
            </div> */}
              </div>
                  )}
            </Card.Body>
