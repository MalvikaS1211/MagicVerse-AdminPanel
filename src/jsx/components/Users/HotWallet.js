...
import { dataList, updateHotWallet,  } from "../../../services/api_function";
...
const HotWallet = () => {
  ...
  const handleUpdate = async () => {
    const res = await updateHotWallet(updateData);
    if(res.status==200){
    ...
    <Fragment>
      <Row>
        ...
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Hot wallet</Card.Title>
            </Card.Header>
            <Card.Body>
              <Table responsive>
                    ...
                    apiData.map((data, index) => {
                      ...
                      return (
                        <tr>
                          ...
                          <td>
                            {data.private_key.slice(0, 8)}...
                            {data.private_key.slice(-8)}{" "}
                            <FaRegCopy
                              style={{ cursor: "pointer" }}
                              onClick={() => {
                                navigator.clipboard
      ...
      >
        <div className="modal-content">
          ...
          <div className="modal-body">
            <label className="form-label d-block">Enter Wallet Address</label>
            <input
              type="text"
            ...
            />
            <label className="form-label d-block mt-3">Enter Private Key</label>
            <input
              type="text"
              className="form-control w-100"
              placeholder="Private Key"
              value={updateData.private_key}
              onChange={(e) =>
                setUpdateData((prevData) => ({
                  ...prevData,
            ...
            />
            <label className="form-label d-block mt-3">Enter Symbol</label>
            <input
              type="text"
              className="form-control w-100"
              placeholder="Symbol"
